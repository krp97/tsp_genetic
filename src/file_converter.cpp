...
//---------------------------------------------------------------------
void file_converter::error_exit(const string& msg)
{
    cout << msg << endl;
    system("PAUSE");
    exit(1);
...
//---------------------------------------------------------------------
int file_converter::header_get_size(ifstream& file)
{
    int header_lines = 0;
    int size         = 0;
    string line;
...
//---------------------------------------------------------------------
int file_converter::value_digits(int val)
{
    int width = 0;
...
//---------------------------------------------------------------------
int file_converter::convert(const std::string& filename_in,
        ...
        for (int j = 0; j < size; j++)
        {
            ...
            if (i == j)
            {
                if (i == 0)
                    ...
                    cout << "WARNING: Diagonal data inconsistent (" << i << ","
                         << j << ")" << endl
                         << endl;
                dist = 0;
            }
